...
<Link
  label="Here's a good resource with screenshots of the different keyboards"
  href="https://css-tricks.com/everything-you-ever-wanted-to-know-about-inputmode/"
/>
...
<CodeTabs label="Autocomplete examples" tabs={["new-password","one-time-code"]}>
...
<SnippetCallout title="A quick note about internationalisation">
