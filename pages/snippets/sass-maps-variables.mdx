...
import { SnippetSandpackWrapper } from "components/snippets/SnippetSandpack/SnippetSandpackWrapper";
...
<Code filename="_typography.scss">
...
<CodeTabs label="Setting CSS variables with and without the mixin" tabs={["_typography.css","_typography.scss"]}>

<CodeTab label="_typography.css">
...
<CodeTab label="_typography.scss">
