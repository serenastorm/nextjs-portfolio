...
```meta:tsx validation/FormValidationSchema.tsx
...
```meta:tsx components/Checkbox.tsx
...
```meta:scss styles/styles.scss hidden
@import "additional-styles";
@import "checkbox";
```

```meta:scss styles/variables.scss hidden
$nav-gap: 8px;
$white: #fff;
$text: #5e5252;
$text-hover: #403434;
...
```meta:scss styles/additional-styles.scss hidden
...
```meta:scss styles/checkbox.scss
@import "variables";
